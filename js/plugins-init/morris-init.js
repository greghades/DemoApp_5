    ...
    var dzMorris = function () {
        ...
        var donutChart = function () {
            Morris.Donut({
                ...
                resize: true,
                redraw: true,
                colors: ['#fd683e', 'rgb(255, 92, 0)', '#624fd1'],
                //responsive:true,
        ...
        var lineChart2 = function () {
            ...
            Morris.Area({
                ...
                pointSize: 3,
                fillOpacity: 0,
                pointStrokeColors: ['#EE3C3C', '#624fd1', '#fd683e'],
                behaveLikeLine: true,
                gridLineColor: 'transparent',
                lineWidth: 3,
                hideHover: 'auto',
                lineColors: ['rgb(238, 60, 60)', 'rgb(0, 171, 197)', '#fd683e'],
                resize: true
        ...
        var barChart = function () {
            if (jQuery('#morris_bar').length > 0) {
                ...
                Morris.Bar({
                    ...
                    ykeys: ['a', 'b', 'c'],
                    labels: ['A', 'B', 'C'],
                    barColors: ['#fd683e', '#624fd1', '#ff9f00'],
                    hideHover: 'auto',
                    gridLineColor: 'transparent',
                    resize: true,
                    barSizeRatio: 0.25,
        ...
        var areaChart = function () {
            ...
            Morris.Area({
                ...
                lineColors: ['#fd683e', 'rgb(16, 202, 147)', 'rgb(255, 92, 0)'],
                xkey: 'period',
                ykeys: ['smartphone', 'windows', 'mac'],
                labels: ['Phone', 'Windows', 'Mac'],
                pointSize: 0,
