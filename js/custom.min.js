var lezato = function () {
   "use strict";
   var e = $(window).width(), t = ($(window).height(), function () {
   ...
   return {
      init: function () {
         ...
         jQuery("#menu").length > 0 && $("#menu").metisMenu(), jQuery(".metismenu > .mm-active ").each(function () {
            ...
            var t = $("input[name='" + fieldName + "']"), n = parseInt(t.val());
            ...
            var t = $(this).attr("rel"), n = $(this).attr("id");
            $.ajax({
               method: "POST", url: t, dataType: "html", success: function (e) {
         ...
         }(), jQuery("#datetimepicker1").length > 0 && $("#datetimepicker1").datetimepicker({inline: !0}), jQuery("#ckeditor").length > 0 && ClassicEditor.create(document.querySelector("#ckeditor"), {}).then(e => {
            window.editor = e
         }).catch(e => {
         ...
         e > 1024 && $(".metismenu  li").unbind().each(function (e) {
            if ($("ul", this).length > 0) {
               var t = (o = $("ul:first", this).css("display", "block")).offset().left, n = o.width(),
                  o = $("ul:first", this).removeAttr("style"), a = ($("body").height(), $("body").width());
               if (jQuery("html").hasClass("rtl")) var l = t + n <= a; else l = t > 0;
...
jQuery(document).ready(function () {
   $('[data-bs-toggle="popover"]').popover(), lezato.init()
}), jQuery(window).on("load", function () {
   "use strict";
   lezato.load(), setTimeout(function () {
      lezato.handleMenuPosition()
   }, 1e3)
}), jQuery(window).on("resize", function () {
   "use strict";
   lezato.resize(), setTimeout(function () {
      lezato.handleMenuPosition()
   }, 1e3)
});