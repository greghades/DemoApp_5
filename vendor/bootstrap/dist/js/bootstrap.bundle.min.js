...
!function (t, e) {
   ...
   const Ne = {
      ...
      name: "preventOverflow", enabled: !0, phase: "main", fn: function (t) {
         var e = t.state, i = t.options, n = t.name, s = i.mainAxis, o = void 0 === s || s, r = i.altAxis,
            ...
            O = "function" == typeof m ? m(Object.assign({}, e.rects, {placement: e.placement})) : m, C = {x: 0, y: 0};
         if (E) {
            if (o || a) {
   ...
   const Fe = Object.freeze({
      ...
      ii = m() ? "top-end" : "top-start", ni = m() ? "top-start" : "top-end", si = m() ? "bottom-end" : "bottom-start",
